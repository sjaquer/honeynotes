...
import { CheckCircle2, Clock, Gift, Loader2, RefreshCw, Trophy, Coins, Crown, NotebookTabs } from 'lucide-react';
    ...
    <div className="paper-app-bg paper-noise flex flex-1 flex-col">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="flex items-center gap-2 text-2xl font-bold text-primary lg:text-3xl">
              <NotebookTabs className="size-7" /> {t('tasksPage.title')}
            </h1>
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="glass-paper flex items-center gap-2 rounded-full bg-purple-100/70 px-3 py-1.5">
              <Crown className="size-4 text-purple-700" />
      ...
      <div className="flex-1 space-y-4 overflow-y-auto p-4 pb-32 lg:p-6">
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="glass-paper flex flex-col items-center rounded-2xl p-4">
          ...
          {tasks.map((task) => {
            ...
            return (
              <div
                key={task.taskId}
                className={cn(
                  'glass-paper rounded-2xl border-2 p-4 transition-all',
        ...
        {/* Info Note */}
        <div className="glass-paper rounded-2xl bg-amber-50/90 p-4">
          <div className="flex items-start gap-3">
